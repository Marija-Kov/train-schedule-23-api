...
const timetableMatrix_d1 = createTimetableMatrix_d1(
  departureTimes_d1,
  stations,
  trainId_d1
);

const timetableMatrix_d2 = createTimetableMatrix_d2(
  departureTimes_d2,
  stations,
  trainId_d2
);

const trainsDataShaped = shapeTrainsData(
  trainId_d1,
  trainId_d2,
  trainIdActiveOnWeekendsAndHolidays_d1,
  trainIdActiveOnWeekendsAndHolidays_d2,
...
const stationsDataShaped = shapeStationsData(
  stations,
  stationsFormatted,
  trainsDataShaped
);

writeTrainsEndpoint(trainsDataShaped);

writeStationsEndpoint(stationsDataShaped);
