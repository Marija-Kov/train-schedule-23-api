...
test("extractDepartureTimes()", () => {
  ...
  test(` data extracted correctly for direction 2`, () => {
    ...
    if (
      data[7].join(",") ===
      "6.02,6.44,6.40,7.10,7.25,8.13,8.40,9.10,9.19,9.40,10.25,11.25,11.50,12.25,13.25,14.25,15.05,15.10,15.40,16.10,16.19,16.40,17.10,17.40,18.25,19.05,19.19,19.25,20.03,20.25,20.44,21.37,21.37,21.40,22.51"
    ) {
      console.log(`  beograd centar ✅`);
    } else {
      console.log(`  beograd centar ❌`);
